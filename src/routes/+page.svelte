...
<!--SO faux code
Right here we want our header make a component for that 

+ Header will include the following 
    -Icon 
    -Menu? How do i do that? 
    -Title should be clickable and lead home

+We're going to want our animation component here 
It should include a moving hello kitty pixel art going through it every so often kind of like the AHF Website
